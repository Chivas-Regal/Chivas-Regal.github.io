...
|利用限制条件有|$\begin{aligned}
&\because a-1\lt \sqrt b\lt a\\
&\therefore 0\lt a-\sqrt b\lt 0\\
&\therefore(a+\sqrt b)^n=2A_n-(a-\sqrt b)^n\left
\{\begin{aligned}&\lt 2A_n\\
&\gt 2A_n-1\end{aligned}\right.
\Rightarrow \left\lceil(a+\sqrt b)^n\right\rceil=2A_n
\end{aligned}$|
