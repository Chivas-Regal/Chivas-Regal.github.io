...
|利用限制条件有| $\because a-1\lt \sqrt b\lt a$ <br /> $\therefore 0\lt a-\sqrt b\lt 0$ <br /> $\therefore (a+\sqrt b)^n=2A_n-(a-\sqrt b)^n$ ${\begin{aligned} &\lt 2A_n \\ &\gt 2A_n-1\end{aligned}\right.$ $\Rightarrow \left\lceil(a+\sqrt b)^n\right\rceil=2A_n$ |
